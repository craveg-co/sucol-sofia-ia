...
Funciona con Meta Cloud API gracias a la capa de providers.
"""
...
# Proveedor de WhatsApp (Meta Cloud API, configurado en .env)
...
async def webhook_handler(request: Request):
    ...
    try:
        ...
        for msg in mensajes:
            ...
            # Enviar respuesta por WhatsApp via Meta Cloud API
